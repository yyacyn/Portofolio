                ...
                <section className="mt-10 lg:w-[700px] mx-auto min-h-screen mb-5 bg-white dark:bg-gray-800 p-5 rounded-md shadow-lg">
                    <div className="flex flex-row">
                        <div className="flex flex-col">
                            <h2 className="text-blue-700 dark:text-blue-400 font-bold text-lg lg:text-3xl">Wibuotack</h2>
                            <span className='max-w-[200px] h-1 mt-1 bg-blue-700 dark:bg-blue-400 rounded-md'></span>
                            <p className='py-5 text-sm lg:text-base'>Wibuotack is the name of the group where I done my projects. The projects consist of two products, those are PowerPoint and Motion Graphics. The projects were done within 7 weeks and presented in a formal way to our 'client'.</p>
                            <div className='flex flex-col lg:flex-row gap-5 mx-auto my-2'>
                                <Image src="/wibuotack/Picture1.png" width={300} height={300} className='shadow-lg'/>
                                <Image src="/wibuotack/Picture2.png" width={300} height={300} className='shadow-lg'/>
                            </div>
                            <div className='flex flex-col lg:flex-row gap-5 mx-auto'>
                                <Image src="/wibuotack/Picture3.png" width={300} height={300} className='shadow-lg'/>
                                <Image src="/wibuotack/Picture4.png" width={300} height={300} className='shadow-lg'/>
                            </div>
                            <p className='py-5 text-sm lg:text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi voluptates cupiditate provident non consectetur excepturi inventore voluptatibus totam similique. Facere placeat ea quibusdam accusamus autem distinctio itaque dolorum labore recusandae?</p>
                        </div>
                    </div>
                </section>
            </main>
