                ...
                <section className="mt-10 lg:w-[700px] mx-auto min-h-screen mb-5 bg-white dark:bg-gray-800 p-5 rounded-md shadow-lg">
                    <div className="flex flex-row">
                        <div className="flex flex-col">
                            <h2 className="text-blue-700 dark:text-blue-400 font-bold text-lg lg:text-3xl">Breaking Corrupt</h2>
                            <span className='max-w-[280px] h-1 mt-1 bg-blue-700 dark:bg-blue-400 rounded-md'></span>
                            <p className='py-5 text-sm lg:text-base'>Breaking Corrupt is a visual novel game made using Ren'Py game engine. This game follows a story about a detective trying to uncover a druglord that has been dealing and corrupting a small town in Alberqueue, New Mexico.</p>
                            <div className='flex flex-col lg:flex-row gap-5 mx-auto my-2'>
                                <Image src="/breakingcorrupt/image.png" width={300} height={300} className='shadow-lg'/>
                                <Image src="/breakingcorrupt/image1.png" width={300} height={300} className='shadow-lg'/>
                            </div>
                            <div className='flex flex-col lg:flex-row gap-5 mx-auto'>
                                <Image src="/breakingcorrupt/image2.png" width={300} height={300} className='shadow-lg'/>
                                <Image src="/breakingcorrupt/image3.png" width={300} height={300} className='shadow-lg'/>
                            </div>
                            <p className='py-5 text-sm lg:text-base'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste amet asperiores error quis cupiditate quae alias labore tenetur excepturi laboriosam iusto, quas officiis? Unde aspernatur, culpa saepe ex voluptate alias.</p>
                        </div>
                    </div>
                </section>
            </main>
